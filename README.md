...
# 안녕하세요! 👋 코딩하는 교사, 박권(Kwon Park)입니다.

### 🍎 Teacher | 💻 Code Enthusiast

**"교육(Education)과 기술(Technology)의 연결고리를 만들어갑니다."**
...
- 🏫 현재 **호원중학교(Howon Middle School)**에서 아이들을 가르치고 있습니다.
- 🌱 **Python, JavaScript** 등 프로그래밍 언어를 배우며 교육적 활용 방안을 연구합니다.
- 💡 **에듀테크(EdTech)** 도구를 활용하여 수업을 개선하는 데 관심이 많습니다.
- 💬 교육과 기술이 만나는 지점에 대해 이야기 나누는 것을 좋아합니다.

<br/>

### 🛠️ Tech Stack & Tools (Learning Journey)
